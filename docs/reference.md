# wFirma MCP reference

For a quick start, see the [README](../README.md). Commands below run from the repository root.
...
See [the privacy and protocol audit](privacy-and-protocol-audit.md) for the checked standard changes, data boundaries and verification limits.
